    ...
    <div className={`relative ${className}`}>
      ...
      <div
        ...
        style={{
          ...
          fontFamily:
            '"Poppins", "SF Pro Display", "Inter", -apple-system, BlinkMacSystemFont, sans-serif',
          fontWeight: 900,
          letterSpacing: '-0.02em',
          background:
            'linear-gradient(135deg, #00D4FF 0%, #0EA5E9 25%, #1E40AF 50%, #14B8A6 75%, #10B981 100%)',
      ...
      <div
        ...
        style={{
          width: '100%',
          background:
            'linear-gradient(90deg, transparent 0%, #00D4FF 20%, #14B8A6 50%, #10B981 80%, transparent 100%)',
...
export function AskmaTextPremium({
  size = 24,
  className = '',
}: AskmaLogoProps) {
  const fontSize = size * 0.8;
    ...
    <div className={`relative ${className}`}>
        ...
        {[...Array(6)].map((_, i) => (
          <div
            ...
            style={{
              ...
              top: `${20 + (i % 2) * 40}%`,
              backgroundColor:
                i % 3 === 0 ? '#00D4FF' : i % 3 === 1 ? '#14B8A6' : '#10B981',
      ...
      <div
        ...
        style={{
          width: '100%',
          background:
            'linear-gradient(90deg, #00D4FF, #0EA5E9, #1E40AF, #14B8A6, #10B981, #059669)',
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 -z-10 blur-2xl opacity-30">
          <div
            ...
            style={{
              background:
                'radial-gradient(circle, #00D4FF 0%, #14B8A6 50%, #10B981 100%)',
              transform: 'scale(1.5)',
            }}
          />
        </div>
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 -z-10">
          <div
            ...
            style={{
              background:
                'linear-gradient(45deg, #00D4FF, transparent, #14B8A6, transparent, #10B981)',
              filter: 'blur(20px)',
              transform: 'scale(1.2)',
            }}
          />
...
// 小さいサイズ用
export function AskmaLogoCompact({
  size = 20,
  className = '',
}: AskmaLogoProps) {
  return <AskmaLogo size={size} className={className} />;
...
// アニメーション付きロゴ
export function AskmaLogoAnimated({
  size = 32,
  className = '',
}: AskmaLogoProps) {
  return (
...
// 回転アニメーション
export function AskmaLogoSpinning({
  size = 32,
  className = '',
}: AskmaLogoProps) {
  return (
...
export function AskmaLogoHover({ size = 32, className = '' }: AskmaLogoProps) {
  return (
    <div
      className={`transition-all duration-300 hover:scale-110 hover:drop-shadow-2xl ${className}`}
    >
      <AskmaLogo size={size} />
    </div>
  );
...
// クリック可能版
export function AskmaLogoClickable({
  size = 32,
  className = '',
  onClick,
}: AskmaLogoProps & { onClick?: () => void }) {
  return (
    <button
      onClick={onClick}
